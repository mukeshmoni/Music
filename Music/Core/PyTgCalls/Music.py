    ...
    if int(assistant) == 1:
        try:
            ...
            return await mystic.edit(
                "ꜰᴀɪʟᴇᴅ ᴛᴏ ᴄʜᴀɴɢᴇ ᴠɪᴅᴇᴏ ꜱᴛʀᴇᴀᴍ.. ᴘʟᴇᴀꜱᴇ ꜱᴋɪᴘ ᴀɢᴀɪɴ."
            )
    elif int(assistant) == 2:
        try:
            await pytgcalls2.change_stream(
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) == "raw":
                ...
                finaltext = await app.send_photo(
                    ...
                    caption=f"🎥<b>__ꜱᴛᴀʀᴛᴇᴅ ꜱᴛʀᴇᴀᴍɪɴɢ:__</b> {title} \n👤<b>__ʀᴇQᴜᴇꜱᴛᴇᴅ ʙʏ:__ </b> {mention}",
                )
                await start_timer(
                    videoid,
                    duration_min,
                ...
                if int(quality) == 1080:
                    ...
                    try:
                        ...
                        return await app.send_message(
                            chat_id,
                            "ꜱᴏᴍᴇ ᴇʀʀᴏʀ ᴏᴄᴄᴜʀᴇᴅ ᴡʜɪʟᴇ ꜱᴡɪᴛᴄʜɪɴɢ ᴠɪᴅᴇᴏ ꜱᴛʀᴇᴀᴍ. ᴘʟᴀʏᴏᴜᴛ ɪꜱ ᴏɴ ʜᴏʟᴅ ɴᴏᴡ. ᴘʟᴇᴀꜱᴇ ꜱᴋɪᴘ ᴛʜᴇ ꜱᴛʀᴇᴀᴍ ᴛᴏ ʀᴇꜱᴜᴍᴇ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.",
                        )
                    ...
                    finaltext = await app.send_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(buttons),
                        caption=(
                            f"**ᴠɪᴅᴇᴏ ꜱᴛʀᴇᴀᴍɪɴɢ**\n\n🎥<b>__ꜱᴛᴀʀᴛᴇᴅ ᴘʟᴀʏɪɴɢ:__ </b>Next Video from Telegram \n👤**__ʀᴇQᴜᴇꜱᴛᴇᴅ ʙʏ:__** {mention}"
                        ),
                    )
                else:
                    (
                    ...
                    if nrs == 0:
                        return await app.send_message(
                            chat_id,
                            "ꜰᴀɪʟᴇᴅ ᴛᴏ ꜰᴇᴛᴄʜ ᴠɪᴅᴇᴏ ꜰᴏʀᴍᴀᴛꜱ ꜰᴏʀ ɴᴇxᴛ ꜱᴛʀᴇᴀᴍ. ᴘʟᴇᴀꜱᴇ ꜱᴋɪᴘ ᴛʜᴇ ꜱᴛʀᴇᴀᴍ ᴛᴏ ʀᴇꜱᴜᴍᴇ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.",
                        )
                    try:
                        await pytgclients.change_stream(
                            chat_id,
                    ...
                    finaltext = await app.send_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(buttons),
                        caption=(
                            f"**ᴠɪᴅᴇᴏ ꜱᴛʀᴇᴀᴍɪɴɢ**\n\n🎥<b>__ꜱᴛᴀʀᴛᴇᴅ ᴘʟᴀʏɪɴɢ:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={afk}) \n👤**__ʀᴇQᴜᴇꜱᴛᴇᴅ ʙʏ:__** {mention}"
                        ),
                    )
                    os.remove(thumb)
                    await start_timer(
                ...
                finaltext = await app.send_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(buttons),
                    caption=(
                        f"🎥<b>__ꜱᴛᴀʀᴛᴇᴅ ᴘʟᴀʏɪɴɢ:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={afk}) \n👤**__ʀᴇQᴜᴇꜱᴛᴇᴅ ʙʏ:__** {mention}"
                    ),
                )
                os.remove(thumb)
                videoid = afk
